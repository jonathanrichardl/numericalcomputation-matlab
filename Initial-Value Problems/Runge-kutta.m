clear all
clc
dydt=@(t,y) 9.81 - (0.4*y*y)/68.1 ; %masukin fungsi yang dikasih di soal
rentangwaktu = [0 10]; %masukkin waktu yang disuruh di soal, misal disuruh 7detik, maka masukin [0 7] 
initial = 1 %nilai y(0), kalo gadiketahui biarin aja 1
stepsize = 2 %nilai stepsize, ganti sesuai soal
[t,y] = rk4sys(dydt,rentangwaktu ,initial,stepsize); 
disp([t.',y] );
